...
/**
 * <p>
 * Java class for ceiling complex type.
 * 
 * <p>
...
@XmlType(name = "ceiling")
public class Ceiling implements Cloneable
{
	...
	/**
	 * Creates a new {@code Ceiling} instance.
	 * 
	 */
	public Ceiling()
	{
	...
	/**
	 * Creates a new {@code Ceiling} instance by deeply copying a given
	 * {@code Ceiling} instance.
	 * 
	 * 
	 * @param o
	 ...
	 */
	public Ceiling(final Ceiling o)
	{
		// CC-XJC Version 2.0.1 Build 2012-03-02T12:09:12+0000
		super();
		if (o == null)
		{
			throw new NullPointerException("Cannot create a copy of 'Ceiling' from 'null'.");
		}
	...
	public Ceiling clone()
	{
		try
		{
			{
				// CC-XJC Version 2.0.1 Build 2012-03-02T12:09:12+0000
				final Ceiling clone = ((Ceiling) super.clone());
				// CBuiltinLeafInfo: java.lang.String
